...
export default function InternalLayout({
  ...
  return (
    <div className={`relative min-h-screen overflow-hidden internal-bg ${className || ''}`}>
      ...
      {/* Subtle overlay to reduce whiteness and add depth (theme-aware) */}
      <div className="absolute inset-0 pointer-events-none bg-black/10 dark:bg-white/5 mix-blend-multiply" />
